...
\CommentTok{\# This value is clearly wrong (4) so we changed it to the mean of ages}
\NormalTok{survey\_data}\SpecialCharTok{$}\NormalTok{age[}\DecValTok{55}\NormalTok{] }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(survey\_data}\SpecialCharTok{$}\NormalTok{age))}
